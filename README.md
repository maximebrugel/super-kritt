> **super·kritt fork:** This repository tracks
> [open·kritt](https://github.com/Kritt-ai/open-kritt) with custom additions.
...
- **Kimi (Moonshot AI) model provider** — select Kimi plan models with a
  `KIMI_API_KEY` from the [Kimi Code console](https://www.kimi.com/code/console).
- **Two Kimi harnesses** — use Claude Code through Kimi's Anthropic-compatible
  endpoint, or select the native `kimi-code` harness.

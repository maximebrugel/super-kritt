...
Commits submitted to this fork require a DCO sign-off. The bundled
[`CONTRIBUTION_TERMS.md`](CONTRIBUTION_TERMS.md) describe submissions to the official
Kritt-ai/open-kritt repository and do not apply automatically to this fork.
...
- **Releases are manual**; this fork does not run release-please (see [`RELEASE.md`](RELEASE.md)).
